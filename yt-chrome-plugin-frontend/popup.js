...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const API_KEY = "AIzaSyBdlo4sCPiswd88sljaHdGDVVGWSzgiyCk"; // Replace with your actual YouTube Data API key
    ...
    try {
      while (comments.length < 500) {
        const response = await fetch(
          `https://www.googleapis.com/youtube/v3/commentThreads?part=snippet&videoId=${videoId}&pageToken=${pageToken}&key=${API_KEY}`
        );
